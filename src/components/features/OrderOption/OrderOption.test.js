      ...
      switch (type) {
        ...
        /* tests for icons */
          it('contains div and icons', () => {
            ...
            expect(emptyDiv).toBe(0);
            
            const divIcon = div.find('Icon').not('[name="times-circle"]');
            expect(divIcon.length).toBe(mockProps.values.length);
            expect(divIcon.at(0).prop('name')).toBe(mockProps.values[0].icon);
            expect(divIcon.at(1).prop('name')).toBe(mockProps.values[1].icon);
          });
        ...
        /* tests for numbers */
          it('contains div and input', () => {
            ...
            expect(inputs.prop('type')).toBe('number');
